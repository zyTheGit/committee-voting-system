...
export class BaseApiResponse<T> {
  public result: T; // Swagger Decorator is added in the extended class below, since that will override this one.
...
export class BaseApiErrorResponse extends BaseApiResponse<
  BaseApiErrorObject
> {}
